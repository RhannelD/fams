<form class="modal-content" wire:submit.prevent="save">
    ...
    <h5 class="modal-title" id="exampleModalCenterTitle">Category {{ ((isset($category_id))? 'Editing': 'Creating') }}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true"><i class="fas fa-times-circle text-white"></i></span>
        </button>
    </div>
    <div class="modal-body category_creating">
        @include('livewire.form.category-form-livewire')
    </div>
