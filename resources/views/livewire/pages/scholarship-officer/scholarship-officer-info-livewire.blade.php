    ...
    @isset($user)
        ...
        <div class="card mt-2 mb-1">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-info text-white mb-1 mb-lg-0" wire:click="edit({{ $user['id'] }})" data-toggle="modal" data-target="#officer_form">
                    <i class="fas fa-edit"></i>
                    Edit Info
                </button>
                
                <button class="btn btn-info ml-auto mr-0 text-white mb-1 mb-lg-0" type="button" wire:click="nullinputs" data-toggle="modal" data-target="#change_password_form">
