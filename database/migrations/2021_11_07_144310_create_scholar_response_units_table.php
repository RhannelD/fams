...
class CreateScholarResponseUnitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scholar_response_units', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('scholar_response_units', function (Blueprint $table) {
            $table->dropForeign(['response_id']);
            $table->dropForeign(['item_id']);
            $table->dropColumn(['response_id', 'item_id']);
        });
        
        Schema::dropIfExists('scholar_response_units');
    }
}
